...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT,
        properties = "gatepass.private-key=" + GatewayEd25519IntegrationTests.GATEWAY_PRIVATE)
class GatewayEd25519IntegrationTests {
    ...
    private final Gatepass service = Gatepass.builder().trustedService("gateway", GATEWAY_PUBLIC).build();
